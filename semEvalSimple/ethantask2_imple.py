"""
Train model with consequent, antecedent decomposition obtained
in ethan_decomp.py and compare F1 score

Reprendre le fichier task1,
avant la tokenisation, ajouter les antecedent consequent paires, derriere
dans le format '[sentence]=sentence [antecedent]=antecedent [consequent]=consequent' et train
mais le faire dans le dataframe avec pandas
"""
import os
import pandas as pd
import torch
